...
#define CONFIG_EXAMPLES_DIR "Ender 2 Pro-BTT-V3"
...
#define STRING_CONFIG_H_AUTHOR "(Gorilla Tech 3D - BTT-SKR-Mini-E3-V3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender 2 Pro-BTT-V3"
